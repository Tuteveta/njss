        ...
        <div className="bg-emerald-50 border-b border-emerald-200 py-3 px-4">
          <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 text-sm">
            ...
            <span className="text-emerald-900">
              {s.banner_text}{" "}
              {s.banner_link && (
                <Link to={s.banner_link} className="underline font-medium">Learn more →</Link>
              )}
            </span>
          </div>
        </div>
        ...
        <section id="home-news" className="py-10 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-end mb-7">
              ...
              <Link to="/news" className="text-sm font-medium text-[hsl(210,70%,25%)] hover:underline flex items-center gap-1">
        ...
        <section id="home-events" className="py-10 bg-white border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-end mb-7">
              ...
              <Link to="/events" className="text-sm font-medium text-[hsl(210,70%,25%)] hover:underline flex items-center gap-1">
                View all <ChevronRight className="w-4 h-4" />
              </Link>
            </div>
            ...
            {upcomingEvents.length === 0 ? (
              <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 py-14 text-center">
                ...
                <Link to="/events" className="inline-flex items-center gap-2 text-sm font-medium text-[hsl(210,70%,25%)] hover:underline">
        ...
        <section id="cta" className="py-10 bg-white border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 lg:px-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex flex-col gap-2">
                ...
                <div className="mt-auto pt-2.5 border-t border-gray-100">
                  <Link to="/contact" className="inline-flex items-center gap-1.5 text-sm font-semibold text-[hsl(210,70%,25%)] hover:gap-2.5 transition-all">
            ...
            <div className="mt-5 bg-gray-50 rounded-xl border border-gray-100 p-4 flex items-center justify-between gap-4">
              ...
              <Link to="/resources" className="shrink-0 inline-flex items-center gap-1.5 text-sm font-semibold text-[hsl(210,70%,25%)] hover:gap-2.5 transition-all">

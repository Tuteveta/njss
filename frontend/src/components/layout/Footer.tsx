...
const socials = [
  ...
  },
  {
    ...
    svg: <><path d="M4 4l16 16M4 20 20 4" /></>,
  },
  {
    label: "LinkedIn", href: "#",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <div className="text-white font-bold text-sm leading-tight">Office of Workers</div>
                <div className="text-white font-bold text-sm leading-tight">Compensation</div>
            ...
            <div className="flex items-center gap-2">
              {socials.map(({ svg, label, href }) => (
                ...
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 text-gray-400 group-hover:text-white transition-colors">
                    {svg}
                  </svg>
                </a>
              ))}
